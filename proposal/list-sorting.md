# List sorting: Draft 1

*[(Issue #155)](https://github.com/sass/sass/issues/155) [(Issue #3070)](https://github.com/sass/sass/issues/3070)* 

This proposal proposes the addition of a sort function, `list.sort()` to the list module to better support list management and manipulation.
